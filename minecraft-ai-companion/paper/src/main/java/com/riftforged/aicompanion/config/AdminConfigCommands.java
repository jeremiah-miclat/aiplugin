 ...
 * ConfigFileEditor} used by "/aicompanion get|set|config|models" so the strings shown to an admin
 * (and the old-value/new-value/error wording) match the other platforms' commands exactly.
 *
 * <p>Mirrors common's com.riftforged.aicompanion.config.AdminConfigCommands — duplicated here since
 * paper/ doesn't depend on the common/ module (see common/pom.xml).
 */
