 ...
 *
 * <p>Mirrors common's com.riftforged.aicompanion.config.ConfigFieldRegistry — keep both in sync;
 * duplicated here since paper/ doesn't depend on the common/ module (see common/pom.xml).
 */
