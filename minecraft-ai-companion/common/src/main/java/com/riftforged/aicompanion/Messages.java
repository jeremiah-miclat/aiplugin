...
/**
 * Plain bot-logic chat lines (no AI call) — mirrors the MESSAGES object in watcher.js. Shared by
 * the Fabric modules via BotSettings; Paper carries its own copy bound directly to its Bukkit-
 * native BotConfig (predates this shared module, deliberately left as-is — see common/pom.xml).
 */
public final class Messages {
    private final Persona persona;
    private final BotSettings config;

    public Messages(Persona persona, BotSettings config) {
